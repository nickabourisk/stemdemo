"""
Django settings for stemdemo project.
...
AUTH_USER_MODEL = "stemdemoapp.User"
...
PUBLIC_STATE_PATHS = [
    (
        os.path.join(PROJECT_ROOT, "stemdemoapp/templates/PublicState.jstemplate"),
        os.path.join(PROJECT_ROOT, "stemdemoapp/static/js/PublicState.js")
    ),
]
...
WSGI_APPLICATION = 'stemdemo.wsgi.application'
